...
const Content = ({
  ...
  if (align === "left") {
    ...
    alignmentClasses = "origin-bottom-left end-0 bottom-0 sm:start-0 mb-2";
  } else if (align === "top-right") {
    alignmentClasses = "origin-bottom-right end-0 bottom-0 mb-2";
  }
...
const DropdownLink = ({
  ...
  return (
    <Link
      {...props}
      className={
        "block w-full rounded-md px-4 py-2 text-start text-sm leading-5 text-foreground transition duration-150 ease-in-out hover:bg-secondary-default focus:bg-secondary-default focus:outline-none " +
        className
      }
    >
      {children}
